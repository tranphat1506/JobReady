        ...
        <div className="flex flex-col lg:flex-row gap-12 items-center">
          ...
          <div className="lg:w-1/2 w-full mt-12 lg:mt-0">
            <div className="relative w-full max-w-lg mx-auto flex items-center justify-center min-h-[550px]">
              ...
              <div className="absolute top-12 left-2 w-[70%] bg-white border border-zinc-200 rounded shadow-xl p-4 transform -rotate-[10deg] -translate-x-4 -translate-y-6 opacity-95 hover:opacity-100 hover:z-30 hover:-translate-y-10 hover:-translate-x-8 transition-all duration-500 z-20 font-sans cursor-default hidden sm:block">
              ...
              <div className="relative z-10 w-[85%] bg-white border border-zinc-200 rounded-xl shadow-lg p-5 sm:p-6 flex flex-col font-sans select-none hover:scale-[1.02] hover:z-30 transition-all duration-500 opacity-90 hover:opacity-100">
