-- Migration: Clean refund metadata to avoid system error leakage into ledger
-- Date: 2026-06-05
...
BEGIN
  ...
  ELSE
    ...
    -- Write Refund to Ledger with a generic reason, abstracting away the actual p_error_message
